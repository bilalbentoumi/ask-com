...
class Stats {
    ...
    public static function solved_questions_percent() {
        return sprintf('%0.2f', Stats::solved_questions() ? Stats::solved_questions() * 100 / Stats::total_questions() : 0);
    }
    ...
    public static function unsolved_questions_percent() {
        return sprintf('%0.2f', Stats::unsolved_questions() ? Stats::unsolved_questions() * 100 / Stats::total_questions() : 0);
    }
